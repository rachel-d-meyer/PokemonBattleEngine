...
class BaseStats {
    ...
    protected BaseStats()
    {
        ...
        _stats.Add("Heracross", new List<BaseStat> { new BaseStat(HPCalc(80), statCalc(125), statCalc(75), statCalc(40), statCalc(95), statCalc(85)) });
        _stats.Add("Slaking", new List<BaseStat> { new BaseStat(HPCalc(150), statCalc(160), statCalc(100), statCalc(95), statCalc(65), statCalc(100)) });
        _stats.Add("Blissey", new List<BaseStat> { new BaseStat(HPCalc(255), statCalc(10), statCalc(10), statCalc(75), statCalc(135), statCalc(55)) });
        _stats.Add("Sylveon", new List<BaseStat> { new BaseStat(HPCalc(95), statCalc(65), statCalc(65), statCalc(110), statCalc(130), statCalc(60)) });
        _stats.Add("Archeops", new List<BaseStat> { new BaseStat(HPCalc(75), statCalc(140), statCalc(65), statCalc(112), statCalc(65), statCalc(110)) });
        _stats.Add("Nidoking", new List<BaseStat> { new BaseStat(HPCalc(81), statCalc(102), statCalc(77), statCalc(85), statCalc(75), statCalc(85)) });
        _stats.Add("Hippowdon", new List<BaseStat> { new BaseStat(HPCalc(108), statCalc(112), statCalc(118), statCalc(68), statCalc(72), statCalc(47)) });
        _stats.Add("Metagross", new List<BaseStat> { new BaseStat(HPCalc(80), statCalc(135), statCalc(130), statCalc(95), statCalc(90), statCalc(70)) });
        _stats.Add("Umbreon", new List<BaseStat> { new BaseStat(HPCalc(95), statCalc(65), statCalc(110), statCalc(60), statCalc(130), statCalc(65)) });
    }
